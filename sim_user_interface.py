...
class UIMainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.x_graph = pyqtgraph.PlotWidget(self.verticalLayoutWidget_2)
        self.x_graph.setObjectName("x_graph")
        self.verticalLayout_2.addWidget(self.x_graph)
        self.y_graph = pyqtgraph.PlotWidget(self.verticalLayoutWidget_2)
        self.y_graph.setObjectName("y_graph")
        self.verticalLayout_2.addWidget(self.y_graph)
        self.xy_graph = pyqtgraph.PlotWidget(self.verticalLayoutWidget_2)
        ...
        self.yaw_psi.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
